...
stake
    ...
    Verify Label Displays    This is the estimated annual staking reward for staked tokens. Actual annualized staking rewards may differ. Learn more
...
settings_notifications    
    ...
    Verify Label Displays    Funding Offer
