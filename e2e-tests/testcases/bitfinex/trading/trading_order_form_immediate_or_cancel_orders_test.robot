...
trading_order_form_immediate_or_cancel_exchange_normal
    ...
    Create Immediate Or Cancel Order    90000    0.0025    buy    confirm=${False}
    Verify Price Warning Popup
    Create Immediate Or Cancel Order    30000    0.0025    sell    confirm=${False}
    Verify Price Warning Popup
    Create Immediate Or Cancel Order    30000    0.0025    buy
    Create Immediate Or Cancel Order    90000    0.0025    sell
